                ...
                <div class="bg-white rounded-lg shadow-md p-6 card-hover">
                    <div class="space-y-4">
                        <div>
                            ...
                            <input type="text" name="nombre" value="{{ old('nombre') }}" required class="w-full border border-gray-300 rounded-lg px-4 py-2 input-focus">
                            @error('nombre') <p class="text-red-500 text-xs">{{ $message }}</p> @enderror
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Descripción</label>
                            <textarea name="descripcion" rows="3" class="w-full border border-gray-300 rounded-lg px-4 py-2 input-focus">{{ old('descripcion') }}</textarea>
                        </div>
                    </div>
                </div>
