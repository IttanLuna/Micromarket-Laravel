...
<head>
    ...
    <title>Nueva Categoría - MicroMarket</title>
        ...
        <main class="max-w-7xl mx-auto px-4 py-8">
            ...
            <form action="{{ route('categorias.store') }}" method="POST">
                ...
                <div class="mt-6 flex justify-end">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-lg">Guardar Categoría</button>
                </div>
            </form>
        </main>
    </div>
