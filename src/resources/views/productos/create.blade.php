        ...
        <main class="max-w-7xl mx-auto px-4 py-8">
            ...
            <form action="{{ route('productos.store') }}" method="POST">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="descripcion" rows="3" class="w-full border border-gray-300 rounded-lg px-4 py-2">{{ old('descripcion') }}</textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-6 flex justify-end">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-lg">Guardar Producto</button>
                </div>
            </form>
        </main>
    </div>
