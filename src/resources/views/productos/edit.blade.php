                    ...
                    <div class="bg-white rounded-lg shadow-md p-6 card-hover">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="descripcion" rows="3" class="form-input-animated w-full border border-gray-300 rounded-lg px-4 py-2">{{ old('descripcion', $producto->descripcion) }}</textarea>
                            </div>
                        </div>
                    </div>
