...
<head>
    ...
    <title>Editar Producto - MicroMarket</title>
    ...
    <div class="min-h-screen">
        ...
        <main class="max-w-7xl mx-auto px-4 py-8">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="{{ route('productos.index') }}" class="bg-gray-500 hover:bg-gray-600 text-white font-bold py-2 px-4 rounded">← Volver</a>
            </div>
            ...
            <form action="{{ route('productos.update', $producto) }}" method="POST">
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select name="categoria_id" required class="w-full border border-gray-300 rounded-lg px-4 py-2">
                            ...
                            <div>
                                ...
                                <textarea name="descripcion" rows="3" class="w-full border border-gray-300 rounded-lg px-4 py-2">{{ old('descripcion', $producto->descripcion) }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="number" name="precio_compra" step="0.01" min="0" value="{{ old('precio_compra', $producto->precio_compra) }}" required
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2">
                            </div>
                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-1">Precio Venta (Bs.) *</label>
                                <input type="number" name="precio_venta" step="0.01" min="0" value="{{ old('precio_venta', $producto->precio_venta) }}" required
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2">
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <input type="number" name="stock_minimo" min="0" value="{{ old('stock_minimo', $producto->stock_minimo) }}" required
                                    class="w-full border border-gray-300 rounded-lg px-4 py-2">
                            </div>
                        </div>
                    </div>
                ...
                <div class="mt-6 flex justify-end">
                    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-3 px-8 rounded-lg">Actualizar Producto</button>
                </div>
            </form>
        </main>
    </div>
